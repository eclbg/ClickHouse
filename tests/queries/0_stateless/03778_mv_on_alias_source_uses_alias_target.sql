...
-- The MV's source is rewritten from the alias to the target at creation time.
...
-- Test 2: Insert to the source table also triggers the MV
...
-- Test 3: Another insert to alias table
